...
fn main() -> io::Result<()> {
    ...
    fs::rename(
        "../.artifacts/swift-bridge/SwiftBridgeCore.swift",
        "../Swift/Sources/BBSwift/SwiftBridgeCore.swift",
    )?;
    fs::rename(
        "../.artifacts/swift-bridge/SwiftBridge/SwiftBridge.swift",
        "../Swift/Sources/BBSwift/SwiftBridge.swift",
    )?;
