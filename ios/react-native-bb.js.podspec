Pod::Spec.new do |s|
    ...
    s.source       = { :git => "https://github.com/porco-rosso-j/react-native-bb.js.git", :tag => "#{s.version}" }
    s.source_files  = "ios/BBSwift/Swift/Sources/**/*.{h,m,swift}", "ios/**/*.{h,m,swift}", "ios/*.{h,m,swift}"
    s.requires_arc = true
    s.swift_version = '5.6'
